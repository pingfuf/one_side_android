...
public class XListView extends ListView implements OnScrollListener {
     ...
     *
     * @param enable does enable pulling up load more feature
     */
    ...
    private void updateFooterHeight(float delta) {
        ...
        // setSelectedValue(mTotalItemCount - 1); // scroll to bottom
    }
    ...
    public void startRefresh() {
        ...
        updateHeaderHeight(mHeaderViewHeight/* / OFFSET_RADIO */);
        invokeOnScrolling();
        // invalidate();
    }

 ...
 */
public class CircleCareEmptyLineView extends View {

    public CircleCareEmptyLineView(Context context) {
        super(context);
    }

    public CircleCareEmptyLineView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CircleCareEmptyLineView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        canvas.drawPath(pathLine, paint);
        ...
        endX = getWidth() * 3 / 8 + cornerRadius;
        endY = startY;

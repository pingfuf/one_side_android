...
public class CollapsibleTextViewMerchant extends LinearLayout implements OnClickListener {
    ...
    public CollapsibleTextViewMerchant(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CollapsibleTextViewMerchant(Context context) {
        this(context, null);
    }
    ...
    // return mState == COLLAPSIBLE_STATE_SHRINKUP ? true : false;
    // }

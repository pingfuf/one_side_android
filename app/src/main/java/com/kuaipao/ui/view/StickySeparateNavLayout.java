...
public class StickySeparateNavLayout extends LinearLayout {
    ...
    public StickySeparateNavLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(dy) > mTouchSlop) {
                    ...
                    if (mInnerScrollView instanceof ScrollView) {
                        ...
                        if (mInnerScrollView.getVisibility() == GONE)
                            return true;

...
//        LogUtils.d("242242 onAttachedToWindow() CircularP=%s", this);
...
//        LogUtils.d("242242 onDetachedFromWindow() CircularP=%s", this);
     ...
     */
    public static interface CircularProgressViewListener {
        /**

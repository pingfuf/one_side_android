...
import static com.kuaipao.utils.LogUtils.e;
...
public class EnhancedHandler extends Handler {
    ...
    public void runInHandlerThread(Runnable runnable) {
        if (Thread.currentThread() != _thread)
            ...
            try {
                ...
                e(e, "Error occurred in handler run thread");
            }
    }
    ...
    public <T> T callInHandlerThread(Callable<T> callable, T defaultValue) {
        ...
        try {
            ...
            e(e, "Error occurred in handler call thread");
        }
    ...
    public void dispatchMessage(Message msg) {
        ...
        if (callback != null) {
            try {
                ...
                e(e, "Error occurred in handler thread, dispatchMessage");
            }
        } else {
            handleMessage(msg);
        }

 ...
 */
public class XNumberTimePicker extends RelativeLayout {
    ...
    private NumberPickerTimeAdapter mAdapter;
    ...
    public XNumberTimePicker(Context context) {
        super(context);
        init();
    }

    public XNumberTimePicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        ...
        mAdapter = new NumberPickerTimeAdapter(getContext(), VIEW_ITEM_SIZE);
